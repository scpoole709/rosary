...
export class InstructionsES implements Instructions {
  ...
  pages: Page[] =  [
    ...
    { instruction: "Sujeta la primera cuenta y di", file: OurFather, key: "oval-1"},
    { instruction: "Sujeta la segunda cuenta y di", file: HailMary, key: "bead-1"},
    ...
    { instruction: "Haz la señal de la cruz.", key: "cross.5"}
  ];

  homeTitle = "Bienvenidos al Rosario";
  home1 = "Respira hondo y prepárate para tu viaje. Pulsa Iniciar cuando estés listo. "
        + "Solo sigue las instrucciones y todo irá bien. Si no tienes un rosario, imagina si lo tuvieras.";

  home2 = "Una vez que comiences, puedes pulsar el botón de inicio para volver aquí en cualquier momento."
        + "También puedes hacer clic en cualquier cuenta, en la Virgen María o en el Crucifijo para comenzar o retomar tu camino en cualquier punto."

  glossary = [ {key: "Start", translation: "Comenzar"},
              {key: "Meditate", translation: "Meditar"},
              {key: "Cancel", translation: "Cancelar"}];
  }
